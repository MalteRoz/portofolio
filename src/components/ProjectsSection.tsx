...
const sundStack: any = ["React", "SCSS", "TypeScript"];

const sillyStockStack: any = ["React", "expressJs", "nodeJs", "MongoDB"];
const facendiaStack: any = ["React", "expressJs", "nodeJs", "MongoDB"];
