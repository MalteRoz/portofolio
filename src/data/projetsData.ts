...
export const ProjectData: IProject = {
  ...
  year: "November 2024",
  background:
    "I built this project with my classmates where we all tried this as our first react project where we wanted to use APIs to build a bigger application. We started with som wireframes in figma and then turned it into a application. Unfortunately we could not get our backend to work on netlify.",
  challenges: [
    "APIs:  our API turned out to be a scam witch prevented us from getting valid updated data due to other sources having high prices",
    "Design:  Creating unique and appealing designs that stand out in a crowded market.",
    "Code structure: Due to this being our first project we was devided on how we should structure the files in the project.",
  ],
  solutions: [
    {
